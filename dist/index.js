  ...
  return _createClass(TimelineEngine, [
    ...
    },
    {
      ...
      value: function setTime(time, isTick) {
        ...
        if (isTick)
          this.trigger('setTimeByTick', {
            time: time,
            engine: this,
          });
        else
          this.trigger('afterSetTime', {
            time: time,
            engine: this,
          });
        return true;
    ...
    },
    {
      ...
      value: function _startOrStop(type) {
        for (var i = 0; i < this._activeActionIds.length; i++) {
          ...
          if (type === 'start') {
            var _effect$source;
            (effect === null || effect === void 0 ? void 0 : (_effect$source = effect.source) === null || _effect$source === void 0 ? void 0 : _effect$source.start) &&
              effect.source.start({
                action: action,
                effect: effect,
                engine: this,
            ...
            var _effect$source2;
            (effect === null || effect === void 0 ? void 0 : (_effect$source2 = effect.source) === null || _effect$source2 === void 0 ? void 0 : _effect$source2.stop) &&
              effect.source.stop({
                action: action,
                effect: effect,
                engine: this,
  ...
  var setInteractions = function setInteractions() {
    if (draggable)
      interactable.current.draggable(
        _objectSpread2(
          _objectSpread2({}, draggableOptionsRef.current),
          {},
          {
    ...
    if (resizable)
      interactable.current.resizable(
        _objectSpread2(
          _objectSpread2({}, resizableOptionsRef.current),
          {},
          {
            onstart: function onstart(e) {
  ...
  return /*#__PURE__*/ React__default['default'].createElement(
    ...
    /*#__PURE__*/ React__default['default'].cloneElement(children, {
      style: _objectSpread2(
        _objectSpread2({}, children.props.style || {}),
        {},
        {
          left: left,
          width: width,
...
var EditArea = /*#__PURE__*/ React__default['default'].forwardRef(function (props, ref) {
  ...
  var handleUpdateDragLine = function handleUpdateDragLine(data) {
    if (dragLine) {
      var movePositions = defaultGetMovePosition(
        _objectSpread2(
          _objectSpread2({}, data),
          {},
          {
  ...
  React.useLayoutEffect(
    function () {
      ...
      (_gridRef$current = gridRef.current) === null || _gridRef$current === void 0
        ? void 0
        : _gridRef$current.scrollToPosition({
            scrollTop: scrollTop,
      ...
      if (totalHeight < height) {
        ...
        if (heightRef.current !== height && heightRef.current >= 0) {
          setTimeout(function () {
            ...
            return (_gridRef$current2 = gridRef.current) === null || _gridRef$current2 === void 0
              ? void 0
              : _gridRef$current2.recomputeGridSize({
  ...
  return /*#__PURE__*/ React__default['default'].createElement(
    ...
    /*#__PURE__*/ React__default['default'].createElement(reactVirtualized.AutoSizer, null, function (_ref3) {
      ...
      return /*#__PURE__*/ React__default['default'].createElement(
        ...
        null,
        /*#__PURE__*/ React__default['default'].createElement(reactVirtualized.Grid, {
          ref: gridRef,
